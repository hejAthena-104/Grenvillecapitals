...
path set by `ADMIN_URL` in `.env.prod`. The value is deliberately not recorded
in this repo — read it from the server if you need it:
`ssh root@156.67.28.100 'grep ADMIN_URL /opt/grenville/repo/backend/.env.prod'`.
